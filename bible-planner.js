class EthiopianBiblePlanner {
    ...
    renderMonthSelector() {
        ...
        container.innerHTML = this.ethiopianMonths.map(month => `
            <button data-month="${month.id}" class="month-button card p-4 rounded-xl text-left transition-all border-2 ${
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        ${monthHolyDays.map(day => `
                            <div class="card p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow" style="background-color: ${this.brandColors.light}; border-color: ${this.brandColors.secondary}">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ${monthMinistryEvents.map(event => `
                            <div class="card p-4 rounded-lg border-l-4 hover:shadow-md transition-shadow" style="background-color: #f0f9ff; border-color: ${this.brandColors.accent}">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1">
                        ...
                        <div class="plan-section">
                            ...
                            <div class="space-y-3">
                                ${plan.weeklyBreakdown.map(week => {
                                    ...
                                    return `
                                        <div class="card border-2 rounded-xl overflow-hidden hover:shadow-lg transition-all">
                        ...
                        ${this.ntIntensive.map((section, idx) => {
                            ...
                            return `
                                ...
                                ${section.dailyBreakdown.map(day => {
                                    ...
                                    return `
                                        <tr class="week-details hidden" data-parent="${sectionId}">
                                            ...
                                            <td>
                                                <button data-reading="${dayId}" class="complete-toggle flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                                                    ...
                                                    ${isDayCompleted ? '<i data-lucide="check-circle" class="w-4 h-4 text-white"></i>' : ''}
                                                </button>
                                            </td>
                                        </tr>
                                    `;
